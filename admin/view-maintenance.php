...
<head>
    ...
    <style>
        ...
        /* Edit Maintenance button styling */
        .btn.btn-secondary[href*="edit-maintenance"] {
            background: linear-gradient(135deg, #4361ee 0%, #3a51d4 100%);
            color: #ffffff;
            border: none;
        }
        
        .btn.btn-secondary[href*="edit-maintenance"]:hover {
        ...
        [data-theme="dark"] .btn.btn-secondary[href*="edit-maintenance"] {
            background: linear-gradient(135deg, #4e73df 0%, #3d5fc7 100%);
            color: #ffffff;
            border: none;
        }
        
        [data-theme="dark"] .btn.btn-secondary[href*="edit-maintenance"]:hover {
