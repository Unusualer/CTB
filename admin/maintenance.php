...
$allowed_columns = ['id', 'title', 'location', 'status', 'priority', 'start_date', 'end_date', 'created_by_name'];
...
try {
    ...
    $order_by = $sort_column === 'created_by_name' ? 'u.name' : 'm.' . $sort_column;
...
<body>
    ...
    <script>
        ...
        let currentSort = urlParams.get('sort') || 'start_date';
