...
<aside id="adminSidebar" class="<?php echo isset($_COOKIE['sidebar_collapsed']) && $_COOKIE['sidebar_collapsed'] === 'true' ? 'collapsed' : ''; ?>">
    ...
    <div class="sidebar-header">
        <a href="index.php" class="sidebar-logo">
            <img src="../images/logo.png" alt="<?php echo __("Logo"); ?> CTB">
    ...
    <div class="sidebar-user">
        <img src="assets/img/avatars/<?php echo $_SESSION['user_avatar'] ?: 'default.png'; ?>" alt="<?php echo __("User Avatar"); ?>" class="sidebar-user-avatar">
        <div class="sidebar-user-info">
            <div class="sidebar-user-name"><?php echo $_SESSION['user_name']; ?></div>
            <div class="sidebar-user-role"><?php echo __(ucfirst($_SESSION['user_role'])); ?></div>
        </div>
    </div>
    ...
    <nav class="sidebar-menu">
        ...
        <div class="sidebar-menu-category"><?php echo __("Management"); ?></div>
        <ul class="sidebar-menu-items list-unstyled">
            <li class="sidebar-menu-item">
                <a href="properties.php" class="sidebar-menu-link <?php echo $current_page == 'properties.php' || $current_page == 'add-property.php' || $current_page == 'edit-property.php' ? 'active' : ''; ?>">
                    ...
                    <span class="sidebar-menu-text"><?php echo __("Properties"); ?></span>
                </a>
            </li>
            <li class="sidebar-menu-item">
        ...
        <div class="sidebar-menu-category"><?php echo __("Reports"); ?></div>
        <ul class="sidebar-menu-items list-unstyled">
            <li class="sidebar-menu-item">
                <a href="reports.php" class="sidebar-menu-link <?php echo $current_page == 'reports.php' ? 'active' : ''; ?>">
                    ...
                    <span class="sidebar-menu-text"><?php echo __("Reports"); ?></span>
                </a>
            </li>
            <li class="sidebar-menu-item">
                <a href="activity-log.php" class="sidebar-menu-link <?php echo $current_page == 'activity-log.php' ? 'active' : ''; ?>">
                    ...
                    <span class="sidebar-menu-text"><?php echo __("Activity Log"); ?></span>
                </a>
            </li>
        </ul>
        ...
        <ul class="sidebar-menu-items list-unstyled">
            <li class="sidebar-menu-item">
                <a href="settings.php" class="sidebar-menu-link <?php echo $current_page == 'settings.php' ? 'active' : ''; ?>">
                    ...
                    <span class="sidebar-menu-text"><?php echo __("Settings"); ?></span>
                </a>
            </li>
            <li class="sidebar-menu-item">
    ...
    <div class="sidebar-footer">
        <div class="dark-mode-toggle">
            <div class="form-check form-switch">
                ...
                <label class="form-check-label" for="darkModeToggle"><?php echo __("Dark / Light"); ?></label>
            </div>
        </div>
